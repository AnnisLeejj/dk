...
class SuccessActivity : MVPActivity<SuccessPresenter>(), SuccessView {
...
//        }
    ...
    private fun call(tel: String) {
        ...
        addSubscribe(permission.requestEach(Manifest.permission.CALL_PHONE).subscribe { r ->
            when {
                r.granted -> callOut(tel)
                r.shouldShowRequestPermissionRationale -> ToastUtils.showLongToast("请允许拨打电话。")
                else -> //永远拒绝
